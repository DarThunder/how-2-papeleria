 ...
 * la fecha y hora, el total de la venta, el nombre del empleado y la lista de
 * productos vendidos.
 *
 * @author Jazmin
 */
public class HistorialVentaVO {
    ...
    /**
     * Devuelve una cadena con los detalles principales de la venta, como folio,
     * nombre del cajero, fecha y total.
     *
